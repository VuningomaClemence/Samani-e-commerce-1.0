    ...
    <section class="products">
      <div class="container">
        ...
        <div class="product-grid">
          ...
          <div>Aucun canapé disponible.</div>
...
export default class CanapesComponent implements OnInit {
  isAdmin = false;
  db = inject(Firestore);
  ...
  constructor(
    ...
    onAuthStateChanged(auth, async (user) => {
      ...
      // inject MatDialog by adding parameter (can't modify constructor params easily here due to order),
      // we'll add it below by patching the function signature.
    });
  }
